  ...
  return (
    <div className="bg-amber-50">
      ...
      <div className='flex flex-col justify-center items-center'>
        ...
        <Link to={"/"} className="font-bold tracking-tight text-2xl">
        ...
        <nav>
          ...
          <a className="">Mobile App Development</a>
          <a className="">IT Consulting</a>
          <a className="">E Commerce Solution</a>

          <a className="">IT Support</a>
        </nav>
        <nav>
      ...
      <footer className="bg-amber-50 p-4 text-base-content footer sm:footer-horizontal footer-center">
        <aside>
          <p>
            Copyright © {new Date().getFullYear()} - All right reserved <Link to={"/"} 
            className="font-bold tracking-tight ">
                      S<span className="text-purple-600 text-base">y</span>mence IT
           </Link>
          </p>
        </aside>
      </footer>
